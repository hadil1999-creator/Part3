...
# === Output file names ===
output_file = "early_stopping/refactored_code_outputs1_codellama.txt"
timing_file = "early_stopping/model_timings1_codellama.txt"
